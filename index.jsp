...
<body><audio id="player" controls="controls" hidden="true" autoplay src='bg.mp3'></audio>
<!-- banner --> <!-- <iframe src="ip.html" style="display: none;"></iframe> -->
	<div class="banner">
		<nav class="navbar navbar-default">
			<div class="navbar-header navbar-left">
				...
				<h1><a class="navbar-brand" href=""><span>G</span>aofeicm</a></h1>
			</div>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Projects">Projects</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
								<li><a href="memory/index.html">My Class</a></li>
								<!-- <li><a href="http://gaofeicm.cn/Student/main">Student Manager System</a></li> -->
								<li><a href="http://gaofeicm.cn/zTree/login">Rent Manager System</a></li>
								<!-- <li><a href="http://gaofeicm.cn/Dasai">Innovate Cup</a></li> -->
								<li><a href="http://gaofeicm.cn/OA">OA System</a></li>
								<!-- <li><a href="http://gaofeicm.cn/WebChat/user/login">Web Chat</a></li> -->
						...
						<li><a href="http://github.com/gaofeicm"><span data-hover="Tools">GitHub</span></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Have Fun">Have Fun</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
						...
						<li><a href="error/about.html"><span data-hover="About">About</span></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="English">English</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
								<li><a href="http://www.gaofeicm.cn/index_CN.jsp">中文</a></li>
							</ul>
						</li>
					</ul>
					</ul>
		...
		<div class="container">
			<div class="agile_banner_info">
				<div class="agile_banner_info1">
					<h3>Hi , Welecome to <span>Gaofeicm</span></h3>
					<div id="typed-strings" class="agileits_w3layouts_strings">
						<p><i>Gaofeicm</i> is my first personal Website.</p>
						<p>No <i>gorgeous</i> interface, no <i>boring</i> discussion.</p>
						<p>The place we <i>communicate</i> with each other</p>
					</div>
					<span id="typed" style="white-space:pre;"></span>
				</div>
			</div>
			<div class="banner_agile_para">
				<p>The original intention of this site is only to do the project I put on the Internet,
					Record the footprints of my study.</p>
			</div>
